...
//    					});
    					...
    					/* 活跃用户 */
    					$("#homePageImg").attr('src', '../../static_resources/enterbj/images/bg01_05.jpg'); 
    					$('#homePageImg').click(function(){
    						bridge.callHandler('pushViewController',{'type':100,'url':'http://m.banmachewu.com?tn=bjjj'});
    					});
    					/* 办理须知上侧广告 */
...
//    						bridge.callHandler('pushViewController',{'type':100,'url':'http://m.huizuche.com/Cdl/Intro3/cyyy?keyword=1mk_2beijingjiaojing_3cdl_4_5app'});
//    					});
    				}
    			}
    		},
